...
import WorldStatistics from './pages/world/WorldStatistics'
      ...
      <BrowserRouter>
        <Routes>
          <Route path='/'>
            ...
            <Route path='/worldstatistics'>
              <Route index element={ <RequireAuth> <WorldStatistics title='World Statistics'/> </RequireAuth> } />
            </Route>
